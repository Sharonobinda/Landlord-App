...
<Link to ={`/featured/${apartment.id}` }class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="rounded-t-lg h-100px" src={apartment.images} alt={apartment.Apartment_name} />
    </a>
    <div class="p-5">
        <a href="#">
